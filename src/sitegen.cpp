...
<section class="page-intro"><div class="kicker">Workbench</div><h1>From the question<br>to the working machine.</h1><p class="lead">Storage and vehicle diagnostics are the two big projects here. Both demand the same discipline: understand what the machine is doing, preserve the evidence, and test the result.</p><nav class="section-nav" aria-label="Workbench sections"><a href="#infiltratorfs">InfiltratorFS</a><a href="#link">LINK family</a><a href="#repository">Package repository</a><a href="#principles">Working principles</a></nav></section>
...
<section id="repository" class="project-section"><div class="project-heading"><div><span class="kicker">03 / Distribution</span><h2>Package Repository.</h2></div><span class="status-note">Linux Mint &amp; Debian-family desktops · Alpha</span></div><div class="project-intro"><p class="large-copy">One place to find the software.<br>One APT source to keep it updated.</p><p>The software centre brings the Linux applications together, including InfiltratorFS, System Monitor, Calendar and the LINK family. Each project releases independently; the repository checks release package hashes and builds the package catalogue and APT metadata from those packages.</p></div><div class="resource-links"><a href="https://infiltrator-projects.github.io/Infiltrator-Repository/">Browse software &amp; setup instructions ↗</a><a href="https://github.com/Infiltrator-Projects/Infiltrator-Repository">Repository source ↗</a></div></section>
