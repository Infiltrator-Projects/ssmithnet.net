...
<section class="intro-hero" aria-labelledby="home-title">
  ...
  <aside class="home-index" aria-label="Explore the site"><div class="index-caption">A personal collection</div>
    <a href="workbench.html"><span class="index-no">01</span><span><strong>Workbench</strong><small>Filesystems &amp; vehicle diagnostics</small></span><span aria-hidden="true">↗</span></a>
...
<section class="feature-row" aria-labelledby="current-title"><div><div class="kicker">On the bench</div><h2 id="current-title">What happens when you build<br>a filesystem from first principles?</h2></div><div><p>InfiltratorFS is where questions about storage become code: what survives a crash, how old versions are retained, and what it takes to boot and run a real Linux installation.</p><a class="text-link" href="workbench.html#infiltratorfs">The engineering behind InfiltratorFS <span aria-hidden="true">→</span></a><p><a class="text-link" href="https://infiltrator-projects.github.io/Infiltrator-Repository/">Browse the Linux software repository ↗</a></p></div></section>
...
static string render_workbench() {
    return page_start("Workbench", "Inside InfiltratorFS and the LINK vehicle-diagnostics family: storage design, shared architecture and work in progress.", "Workbench") + R"(
<section class="page-intro"><div class="kicker">Workbench</div><h1>From the question<br>to the working machine.</h1><p class="lead">Storage and vehicle diagnostics are the two big projects here. Both demand the same discipline: understand what the machine is doing, preserve the evidence, and test the result.</p><nav class="section-nav" aria-label="Workbench sections"><a href="#infiltratorfs">InfiltratorFS</a><a href="#link">LINK family</a><a href="#repository">Software repository</a><a href="#principles">Working principles</a></nav></section>
...
<section id="link" class="project-section"><div class="project-heading"><div><span class="kicker">02 / Automotive</span><h2>The LINK family.</h2></div><span class="status-note">Shared engine · Manufacturer-specific knowledge</span></div>
...
<section id="repository" class="project-section"><div class="project-heading"><div><span class="kicker">03 / Distribution</span><h2>Infiltrator Repository.</h2></div><span class="status-note">Linux Mint &amp; Debian-family desktops · Alpha</span></div><div class="project-intro"><p class="large-copy">One place to find the software.<br>One APT source to keep it updated.</p><p>The software centre brings the Linux applications together, including InfiltratorFS, System Monitor, Calendar Plus and the LINK family. Each project releases independently; the repository checks release package hashes and builds the package catalogue and APT metadata from those packages.</p></div><div class="resource-links"><a href="https://infiltrator-projects.github.io/Infiltrator-Repository/">Browse software &amp; setup instructions ↗</a><a href="https://github.com/Infiltrator-Projects/Infiltrator-Repository">Repository source ↗</a></div></section>
...
static string render_archive() {
    ...
    vector<Event> e = {
        ...
        {"Now","The work continues.","Cars now share the domain with InfiltratorFS and the LINK diagnostic projects. The tools have changed; it is still a personal website."}
    };
